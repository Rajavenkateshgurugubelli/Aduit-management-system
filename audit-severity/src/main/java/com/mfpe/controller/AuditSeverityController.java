...
public class AuditSeverityController {
	...
	/**
	 * @param auditBenchmarkFeign
	 * @param auditResponseService
	 * @param authorizationService
	 */
	public AuditSeverityController(AuditBenchmarkFeign auditBenchmarkFeign, AuditResponseService auditResponseService,
			AuthorizationService authorizationService) {
		super();
		this.auditBenchmarkFeign = auditBenchmarkFeign;
